  ...
  const sections = [
    {
      id: "intro",
      title: "TRAINER HYUN",
      subtitle: "A Wild Programmer Appeared!",
      content:
    ...
    },
    {
      id: "hobbies",
      title: "DIVERSE",
      subtitle: "Multi-Faceted Interests",
      content:
        ...
        {sections.map((section, index) => {
          ...
          return (
            <div
              ...
              style={{
                transform: `translateZ(${(currentSection - index) * 200}px)`,
                opacity: isActive ? 1 : 0.3,
              }}
            >
              {/* Main 3D Icon */}
              <div
                className="fixed left-1/4 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20"
                style={{
                  transform: `translateX(${
                    -50 + progress * 100
                  }px) translateY(${
                    -50 + Math.sin(progress * Math.PI) * 100
                  }px) rotateY(${progress * 360}deg) scale(${
                    1.5 + Math.sin(progress * Math.PI) * 0.5
                  })`,
                  filter: `drop-shadow(0 0 30px ${
                    section.glowColor.includes("blue")
                      ? "#3b82f6"
              ...
              >
                <div className="text-9xl animate-pulse">{section.mainIcon}</div>
              </div>
                ...
                <div
                  ...
                  style={{
                    ...
                    transform: `translateY(${
                      Math.sin(scrollY * 0.003 + i) * 25
                    }px) translateX(${
                      Math.cos(scrollY * 0.002 + i) * 15
                    }px) rotateZ(${scrollY * 0.02 + i * 45}deg) scale(${
                      0.8 + Math.sin(scrollY * 0.001 + i) * 0.2
                    })`,
              ...
              <div
                className="fixed right-1/4 top-1/2 transform translate-x-1/2 -translate-y-1/2 z-30 max-w-md flex flex-col items-center"
                style={{
                  transform: `translateX(${50 - progress * 100}px) translateY(${
                    Math.cos(progress * Math.PI) * 50
                  }px) rotateX(${Math.sin(progress * Math.PI) * 10}deg)`,
              ...
              >
                ...
                <div
                  ...
                  style={{
                    transform: `translateY(${
                      Math.sin(scrollY * 0.0025 + index) * 4
                    }px)`,
                ...
                <div
                  ...
                  style={{
                    backgroundImage: `url(${textBg})`, // Ensure textBg is imported and accessible
                    ...
                    transform: `translateY(${
                      Math.sin(scrollY * 0.0015 + index) * 3
                    }px)`,
                ...
                >
                  <div className="relative w-full h-full flex items-center">
                    ...
                    >
                      {/* Using a down caret icon from react-icons or emoji */}
                      <FaCaretDown />
                    </button>
                  </div>
                </div>
              ...
              {/* Progress dots */}
              <div
                className="fixed bottom-8 left-1/2 flex gap-3 z-40"
                style={{
                ...
                {sections.map((_, i) => (
                  <div
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-500 ${
                      i === index
                        ? `${section.textColor} scale-150 shadow-lg`
                        : "bg-gray-500"
                    }`}
                    style={{
                      boxShadow:
              ...
              {index < sections.length - 1 && (
                <div
                  className="fixed bottom-16 right-8 text-white/60 text-center animate-bounce z-30"
                  style={{
                    transform: `scale(${1 + Math.sin(scrollY * 0.01) * 0.1})`,
                  }}
                >
                  <div className="text-3xl mb-2">⬇️</div>
                  <p className="text-sm">Continue Journey</p>
                </div>
              )}
              ...
              {index === sections.length - 1 && (
                <div
                  className="fixed bottom-20 left-1/2 flex flex-col sm:flex-row gap-6 z-40"
                  style={{
                    transform: `translateY(${
                      Math.sin(scrollY * 0.01) * 20
                    }px) scale(${1 + Math.sin(scrollY * 0.005) * 0.1})`,
                  }}
                >
                  <button
      ...
      {fairyLights.map((pos, i) => (
        <div
          ...
          style={{
            ...
            transform: `translateX(${
              Math.cos(scrollY * 0.005 + i) * 30
            }px) translateY(${Math.sin(scrollY * 0.007 + i) * 25}px) rotate(${
              scrollY * 0.01 + i * 20
            }deg)`,
